...
tags=(
    openvla-oft-flow-bridge_ck5_200k_rl_eggplant_9steps_repeat1
    openvla-oft-flow-bridge_ck5_200k_rl_eggplant_9steps_repeat2
    openvla-oft-flow-bridge_ck5_200k_rl_eggplant_9steps_repeat3
    openvla-oft-flow-bridge_ck5_200k_rl_eggplant_9steps_repeat4
    openvla-oft-flow-bridge_ck5_200k_rl_eggplant_9steps_repeat5
)
# tags=(
#     debug
# )

load_ckpt_path="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/work_dirs/merged_ckpts_openvla/bridge/eggplant/step9.pt"
