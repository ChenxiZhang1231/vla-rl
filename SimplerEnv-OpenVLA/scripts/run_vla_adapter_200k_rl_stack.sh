...
tags=(
    bridge_ck5_200k_rl_stack_filter_49steps_repeat1
    bridge_ck5_200k_rl_stack_filter_49steps_repeat2
    bridge_ck5_200k_rl_stack_filter_49steps_repeat3
    bridge_ck5_200k_rl_stack_filter_49steps_repeat4
    bridge_ck5_200k_rl_stack_filter_49steps_repeat5
)

load_ckpt_path="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/work_dirs/merged_ckpts/bridge/stack-filter/step49.pt"
