...
tags=(
    bridge_ck5_200k_rl_joint_filter_39steps_repeat1
    bridge_ck5_200k_rl_joint_filter_39steps_repeat2
    bridge_ck5_200k_rl_joint_filter_39steps_repeat3
    bridge_ck5_200k_rl_joint_filter_39steps_repeat4
    bridge_ck5_200k_rl_joint_filter_39steps_repeat5
)

load_ckpt_path="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/work_dirs/merged_ckpts/bridge/joint-filter/step39.pt"
