...
python libero_h5.py \
    ...
    --output-path /inspire/ssd/project/robotsimulation/public/data/LIBERO-Lerobot-DeltaAction/LIBERO-Spatial \
    --executor local \
    --tasks-per-job 5 \
    --workers 100 \
    --use_delta_action
...
python libero_h5.py \
    ...
    --output-path /inspire/ssd/project/robotsimulation/public/data/LIBERO-Lerobot-DeltaAction/LIBERO-Long \
    --executor local \
    --tasks-per-job 5 \
    --workers 100 \
    --use_delta_action
...
python libero_h5.py \
    ...
    --output-path /inspire/ssd/project/robotsimulation/public/data/LIBERO-Lerobot-DeltaAction/LIBERO-Goal \
    --executor local \
    --tasks-per-job 5 \
    --workers 100 \
    --use_delta_action
...
python libero_h5.py \
    ...
    --output-path /inspire/ssd/project/robotsimulation/public/data/LIBERO-Lerobot-DeltaAction/LIBERO-Object \
    --executor local \
    --tasks-per-job 5 \
    --workers 100 \
    --use_delta_action
