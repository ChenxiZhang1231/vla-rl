...
VLAC_PATH="/inspire/ssd/project/robotsimulation/public/huggingface_models/VLAC"
...
HYDRA_FULL_ERROR=1 python -m verl_vla.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.reward_type=vlac \
    actor_rollout_ref.rollout.gpu_memory_utilization=0.5 \
    actor_rollout_ref.ref.log_prob_micro_batch_size=8 \
    actor_rollout_ref.ref.fsdp_config.param_offload=True \
    actor_rollout_ref.rollout.rm_step_interval=5 \
    actor_rollout_ref.reward_model.model_path=$VLAC_PATH \
    actor_rollout_ref.reward_model.fsdp_config.model_dtype=bfloat16 \
    reward_model.type=vlac \
