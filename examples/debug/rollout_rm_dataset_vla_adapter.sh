...
DEFAULT_LIBERO_TARGET_DIR="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/rollouts/debug_hdf5"
DEFAULT_DATASET_NAME="libero_spatial"
DEFAULT_SFT_MODEL_PATH="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/VLA-Adapter/outputs/configs+libero_spatial_no_noops+b8+lr-0.0001+lora-r64+dropout-0.0--image_aug--VLA-Adapter--libero_spatial_no_noops----10000_chkpt"
...
SFT_MODEL_PATH="${5:-$DEFAULT_SFT_MODEL_PATH}"
