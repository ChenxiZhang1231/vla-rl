...
# LOAD_MODEL_PATH="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl/work_dirs/SimpleVLA-RL/exp1-vla_adapter_wm_ffp-full-fixedbug-faster-bridge-stack-filter-cosmos-repeat/SimpleVLA-RL/exp1-vla_adapter_wm_ffp-full-fixedbug-faster-bridge-stack-filter-cosmos-repeat/actor/global_step_49"
# MERGED_OUT_PATH="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/work_dirs/merged_ckpts/bridge/stack-filter-fs-cosmos/step49.pt"
