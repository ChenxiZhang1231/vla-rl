...
# LOAD_MODEL_PATH="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl/work_dirs/SimpleVLA-RL/exp2-vla_adapter_wm_kl-full-fixedbug-faster-bridge-eggplant/SimpleVLA-RL/exp2-vla_adapter_wm_kl-full-fixedbug-faster-bridge-eggplant/actor/global_step_9"
# MERGED_OUT_PATH="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/work_dirs/merged_ckpts/bridge/eggplant-fa/step9.pt"
