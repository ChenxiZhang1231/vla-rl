...
EXPERIMENT_NAME='exp1-vla_adapter_wm_ffp-full-fixedbug-faster-bridge-stack-filter-cosmos-repeat'
...
SCENE_NAME="StackGreenCubeOnYellowCubeBakedTexInScene"
...
DIT_PATH="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/world_model/ActionWorldModel/checkpoints/bridge/predict2_video2world_2b_action_conditioned_finetuning_bridge_2025-10-26_09-13-22/checkpoints/model/iter_000032000.pt"
