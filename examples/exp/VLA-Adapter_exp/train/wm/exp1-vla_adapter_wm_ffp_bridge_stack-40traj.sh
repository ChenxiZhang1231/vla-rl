...
EXPERIMENT_NAME='exp1-vla_adapter_wm_ffp-full-fixedbug-faster-bridge-stack-filter-40traj'
...
JSONL_PATH="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/wm_data_process/WM-data-processed/bridge_for_rl/dataset_40.jsonl"
