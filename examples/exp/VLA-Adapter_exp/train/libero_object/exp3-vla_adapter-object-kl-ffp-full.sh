...
EXPERIMENT_NAME='exp3-vla_adapter-object-kl-ffp-fp16-1w-faster-full-fixedbug-repeat'
...
SFT_MODEL_PATH="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/VLA-Adapter/outputs/configs+libero_spatial_no_noops+b8+lr-0.0001+lora-r64+dropout-0.0--image_aug--VLA-Adapter--libero_object_no_noops----10000_chkpt"
