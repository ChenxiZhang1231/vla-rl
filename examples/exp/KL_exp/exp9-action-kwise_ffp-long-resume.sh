...
EXPERIMENT_NAME='exp9-action-kwise_ffp-fp16-long-resume-resume'
...
LOAD_MODEL_PATH="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl/work_dirs/SimpleVLA-RL/exp9-action-kwise_ffp-long-fp16/SimpleVLA-RL/exp9-action-kwise_ffp-long-fp16/actor/global_step_279"
