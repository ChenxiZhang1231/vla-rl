...
EXPERIMENT_NAME='exp8-action-ffp-long-fp16-resume'
...
LOAD_MODEL_PATH="/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl/work_dirs/SimpleVLA-RL/exp8-action-ffp-long-fp16/SimpleVLA-RL/exp8-action-ffp-long-fp16/actor/global_step_289"
