...
EXPERIMENT_NAME='smolvla-bs32-n8-mb256-lr5e6-kl004-rm7b_5k_ref-ppo-trainset-11-sii-rm-342steps'
...
HYDRA_FULL_ERROR=1 python -m verl_vla.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.algo=ppo \
    ...
    critic.model.vla=$VLA_NAME \
    reward_model.type=vlm_serve \
    reward_model.use_ref=True \
    reward_model.vlm_input_num_frames=50 \
    reward_model.vlm_input_num_ref_frames=20 \
