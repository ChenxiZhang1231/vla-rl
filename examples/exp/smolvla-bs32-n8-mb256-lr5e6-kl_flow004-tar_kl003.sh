...
EXPERIMENT_NAME='smolvla-bs32-n8-mb256-lr5e6-kl_flow004-lr3e6-tar_kl003'
...
HYDRA_FULL_ERROR=1 python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.kl_loss_type=kl_flow \
    actor_rollout_ref.actor.kl_loss_target=0.03 \
