...
EXPERIMENT_NAME='exp1-pi05_libero_10-kl-ffp-full'

# Pi05 在 Libero 上的 SFT 权重目录
SFT_MODEL_PATH="/inspire/ssd/project/robotsimulation/zhangchenxi-253108310322/code/openpi1/openpi/pi05_libero/pi05_base/39000"
CKPT_PATH="work_dirs/$PROJECT_NAME/$EXPERIMENT_NAME"

# DATASET_NAME: libero_10 (libero_Long), libero_90, libero_spatial, libero_object, libero_goal
...
HYDRA_FULL_ERROR=1 python -m verl_vla.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.replan_steps=null \
    ...
    actor_rollout_ref.actor.traj_mini_batch_size=30 \
    ...
    actor_rollout_ref.rollout.reward_type=rule \
