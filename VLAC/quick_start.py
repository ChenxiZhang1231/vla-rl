...
model_path="/inspire/ssd/project/robotsimulation/public/huggingface_models/VLAC"
#download model form https://huggingface.co/InternRobotics/VLAC

#assign video path and task description
test_video='rollouts_debug/step=0--task=libero_spatial_task_0_trial_10--success=False--finish_step=256--ran=618.mp4'
ref_video='rollouts_debug/step=0--task=libero_spatial_task_0_trial_3--success=True--ran=6544.mp4'
...
result_path,value_list,critic_list,done_list = Critic.web_trajectory_critic(
    ...
    done_flag=True,#whether to out put done value
    in_context_done=True,#whether use reference video to generate done value
