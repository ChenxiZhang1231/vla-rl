...
LOG_DIR="logs_black_wxyz_fixedbug"
mkdir -p "$LOG_DIR"
...
python libero_to_json.py \
  ...
  --output_dir=/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/wm_data_process/WM-data-processed/LIBERO-WM-WXYZ-FIXEDBUG/libero_spatial \
...
python libero_to_json.py \
  ...
  --output_dir=/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/wm_data_process/WM-data-processed/LIBERO-WM-WXYZ-FIXEDBUG/libero_goal \
...
python libero_to_json.py \
  ...
  --output_dir=/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/wm_data_process/WM-data-processed/LIBERO-WM-WXYZ-FIXEDBUG/libero_object \
...
python libero_to_json.py \
  ...
  --output_dir=/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/wm_data_process/WM-data-processed/LIBERO-WM-WXYZ-FIXEDBUG/libero_10 \
...
python libero_to_json.py \
  ...
  --output_dir=/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/wm_data_process/WM-data-processed/LIBERO-WM-WXYZ-FIXEDBUG/libero_90 \
