...
python libero_to_json.py \
  ...
  --output_dir=/inspire/ssd/project/robotsimulation/public/data/LIBERO-WM/libero_spatial \
...
python libero_to_json.py \
  ...
  --output_dir=/inspire/ssd/project/robotsimulation/public/data/LIBERO-WM/libero_goal \
...
python libero_to_json.py \
  ...
  --output_dir=/inspire/ssd/project/robotsimulation/public/data/LIBERO-WM/libero_object \
...
python libero_to_json.py \
  ...
  --output_dir=/inspire/ssd/project/robotsimulation/public/data/LIBERO-WM/libero_10 \
...
python libero_to_json.py \
  ...
  --output_dir=/inspire/ssd/project/robotsimulation/public/data/LIBERO-WM/libero_90 \
