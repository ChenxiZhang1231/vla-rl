...
python libero_to_json_addi.py \
  --dataset_dir=/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/rollouts/debug_hdf5 \
  --libero_task_suite=libero_spatial \
  --output_dir=/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/wm_data_process/WM-data-processed/LIBERO-WM-WXYZ-ADDI-VLA-Adapter-Debug/libero_spatial1 \
