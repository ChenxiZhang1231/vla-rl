...
if __name__ == '__main__':
    # --- 请在这里配置您的文件夹路径 ---
    SOURCE_FOLDER = "/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl/work_dirs/gen_rm_for_wm_spatial_rm_data"
    DESTINATION_FOLDER = "/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl/work_dirs/gen_rm_for_wm_spatial_rm_data-fixbug"
