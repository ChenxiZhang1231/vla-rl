...
python src/merge_lora_weights.py \
    --model-path /inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/qwenvl_chat/work_dirs/qwen2.5-vl-7b-sft-lora-baseline-5k-r128/checkpoint-171 \
    --model-base $MODEL_NAME  \
    --save-model-path /inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/qwenvl_chat/work_dirs/qwen2.5-vl-7b-sft-lora-baseline-5k-r128/qwen2.5-vl-7b-sft-lora-baseline-5k-r128-merge-171step \
    --safe-serialization


python src/merge_lora_weights.py \
    --model-path /inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/qwenvl_chat/work_dirs/qwen2.5-vl-7b-sft-lora-baseline-5k-r128/checkpoint-342 \
    --model-base $MODEL_NAME  \
    --save-model-path /inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/qwenvl_chat/work_dirs/qwen2.5-vl-7b-sft-lora-baseline-5k-r128/qwen2.5-vl-7b-sft-lora-baseline-5k-r128-merge-342step \
    --safe-serialization


python src/merge_lora_weights.py \
    --model-path /inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl-dev/qwenvl_chat/work_dirs/qwen2.5-vl-7b-sft-lora-baseline-5k-r128/checkpoint-513 \
    --model-base $MODEL_NAME  \
