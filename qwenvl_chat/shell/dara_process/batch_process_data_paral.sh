...
declare -a experiments=(
    "/inspire/ssd/project/robotsimulation/public/users/zhangjiahui/vla-rl/work_dirs/gen_rm_for_wm_spatial_rm_data" "/inspire/ssd/project/robotsimulation/public/data/rm_for_wm_train_jsonl_spatial/spatial1"
)
