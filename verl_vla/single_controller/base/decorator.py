...
from verl_vla.protocol import DataProtoFuture
...
def _split_args_kwargs_data_proto(chunks, *args, **kwargs):
    from verl_vla.protocol import DataProto, DataProtoFuture
    splitted_args = []
    for arg in args:
...
def dispatch_megatron_compute(worker_group, *args, **kwargs):
    ...
    """
    from verl_vla.single_controller.base.megatron.worker_group import MegatronWorkerGroup
...
def collect_megatron_compute_data_proto(worker_group, output):
    ...
    """
    from verl_vla.protocol import DataProto
    import ray
...
def dispatch_dp_compute(worker_group, *args, **kwargs):
    from verl_vla.single_controller.base.worker_group import WorkerGroup
