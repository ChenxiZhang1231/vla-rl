...
"""
  ...
  # You will be shown a video. Determine if the robot succeeds at placing the orange object on the plate.
  # Success requires BOTH steps to be clearly visible:
  # Lift: The gripper must grasp the orange object and lift it completely off the surface.
  # Placement: The lifted orange object must be moved to be directly over the plate (hovering above counts).
  # Output only one final answer:      
#   12
# You will be shown a video generated by a world model. The target object, the carrot, may undergo deformation in the video frames.. Determine if the robot succeeds at picking up an object and placing it on the plate.

# **Success requires BOTH of these steps to be clearly visible:**
# 1.  **The Lift:** The gripper must grasp **any** object and **clearly lift** it off the surface.
...
# Output the final answer strictly as one of: \\box{Success} or \\box{Failure}.
#8
# You will be shown a video generated by a world model. The target object is an orange carrot, may undergo deformation in the video frames.. Determine if the robot succeeds at picking up an object and placing it on the plate.
...
# First, provide your step-by-step reasoning. Then, provide the final answer.
# Output the final answer strictly as one of: \\box{Success} or \\box{Failure}.
def build_system_prompt_scene(scene='PutCarrotOnPlateInScene'):
  if scene == 'PutCarrotOnPlateInScene':
    return """
You will be shown a video. Determine if the robot succeeds at picking up an object and placing it on the plate.
...
Output the final answer strictly as one of: \\box{Success} or \\box{Failure}.
"""
  elif scene == 'PutSpoonOnTableClothInScene':
    return """
You will be shown a video. Determine if the robot succeeds at picking up an object and placing it on the cloth.
...
2.  **The Placement:** The lifted object must be moved to be **directly over the cloth**. (Hovering above the cloth is sufficient).
3.  Please ignore any color of the cloth.
