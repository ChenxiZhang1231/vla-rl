...
from verl_vla.utils.fsdp_utils import fsdp_version, get_fsdp_full_state_dict, get_fsdp_state_ctx
# from verl.utils.logger import log_with_rank

from .checkpoint_manager import BaseCheckpointManager, BaseCheckpointManagerSmolVLA
        ...
        if 'adapter' in self.checkpoint_contents:
            ...
            with warnings.catch_warnings():
                ...
                if self.rank == 0:
                    ...
                    self.model._fsdp_wrapped_module.save_pretrained(local_path, state_dict=model_state_dict)
